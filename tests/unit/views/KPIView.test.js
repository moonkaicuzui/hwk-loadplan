...
describe('KPIView Module', () => {
    ...
    describe('updateSummary', () => {
        ...
        it('should calculate total orders correctly', () => {
            ...
            // Verify DOM updates were attempted
            const doc = mockDeps.document;
    ...
    describe('updateVendorSection', () => {
        ...
        it('should group data by vendor', () => {
            ...
            // DOM getElementById should be called for vendor-related elements
            expect(mockDeps.document.getElementById).toHaveBeenCalled();
        });
    ...
    describe('updateFactoryCards', () => {
        ...
        it('should handle all four factories', () => {
            ...
            // Should process factories A, B, C, D
            expect(mockDeps.document.getElementById).toHaveBeenCalled();
        });

        it('should handle missing factory data', () => {
            const partialFactoryData = mockOrderData.filter(d =>
                d.factory === 'A' || d.factory === 'B'
            );
    ...
    describe('updateAllKPIs', () => {
        ...
        it('should call all individual update functions', () => {
            // Spy on individual functions (if accessible)
            updateAllKPIs();

            // Verify comprehensive update occurred
            expect(mockDeps.document.getElementById).toHaveBeenCalled();
        });
...
describe('KPIView Integration', () => {
    ...
    it('should handle filter changes', () => {
        ...
        initKPIView({
            ...mockDeps,
            filteredData: mockOrderData.filter(d =>
                d.sddValue && d.crd && new Date(d.sddValue) > new Date(d.crd)
            )
        });
        updateAllKPIs();
