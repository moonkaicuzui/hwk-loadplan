...
const mockOrderData = [
  {
    ...
    production: {
      ...
      s_fit: { completed: 600, status: 'partial' },
      ass_bal: { completed: 500, status: 'partial' },
  ...
  },
  {
    ...
    production: {
      ...
      s_fit: { completed: 100, status: 'partial' },
      ass_bal: { completed: 50, status: 'partial' },
  ...
  },
  {
    ...
    production: {
      ...
      s_fit: { completed: 2000, status: 'completed' },
      ass_bal: { completed: 2000, status: 'completed' },
  ...
  },
  {
    ...
    production: {
      ...
      s_fit: { completed: 300, status: 'partial' },
      ass_bal: { completed: 200, status: 'partial' },
